...
<head>
<meta charset="UTF-8">
<title>人生感悟-方明buptbill220站</title>
    ...
    <div id="content">
       <!--left-->
         <div class="left" id="riji">
           <div class="weizi">
           <div class="wz_text">&nbsp;&nbsp;&nbsp;&nbsp;<h1>人生感悟</h1></div>
           </div>
           <div class="rj_content">
            <?php foreach ($diary as $d):?>
              ...
              <div class="shiguang animated bounceIn">
                ...
                <img src="images/my_1.png" width="120" height="120" alt=""/>
                </div>
                <div class="right sg_text">
                <img src="images/left.png" width="13" height="16" alt="左图标"/>
                <?php echo "<a href='art?aid={$d['id']}' target='_parent'>{$d['sub_title']}</a>";?>
                </div>
                <div class="clear"></div>
              </div>
              <!--时光 end-->
            ...
            if( $tpage > 0 ){
                ...
                if( $pid != 1 ) 
                    echo "<li><a href='diary?pid=$pre'>前一页</a></li>";
                $start = (intval(($pid-1)/5))*5+1;
                for( $i = $start; $i <= $tpage && $i < $start+5 ; ++$i ){
                    if( $i == $pid ) echo "<li class='active'><a>$i</a></li>";
                    else echo "<li><a href='diary?pid=$i'>$i</a></li>";
                }
                if( $i <= $tpage ){
                    echo "<li class='disable'><a>...</a></li>";
                    echo "<li><a href='diary?&pid=$tpage'>$tpage</a></li>";
                }
                if( $pid != $tpage )
                    echo "<li><a href='diary?pid=$next'>后一页</a></li>";
            }
            ?>
            </ul>
            </div>
